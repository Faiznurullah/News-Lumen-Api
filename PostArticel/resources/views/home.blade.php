...
<div class="container">
   ...
   <div class="row">
       ...
       <div class="col-md-6">
        ...
        <input type="text" class="form-control  @error('judul') is-invalid @enderror is-valid" name="judul" id="exampleFormControlInput1" placeholder="Nama Judul">
...
<div class="alert alert-danger">{{ $message }}</div>
       ...
       <div class="col-md-6">
        ...
        <input type="text" class="form-control  @error('penulis') is-invalid @enderror is-valid" name="penulis" id="exampleFormControlInput1" placeholder="Nama Penulis">
        <div class="valid-feedback">
          @error('penulis')
<div class="alert alert-danger">{{ $message }}</div>
       @enderror
